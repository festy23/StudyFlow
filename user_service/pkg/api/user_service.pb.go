...
func (x *ResolvedTutorStudentContext) GetRelationshipExists() bool {
	if x != nil {
		return x.RelationshipExists
	}
	return false
}
...
type TutorProfile struct {
	...
	LessonPriceRub       int32                  `protobuf:"varint,4,opt,name=lesson_price_rub,json=lessonPriceRub,proto3" json:"lesson_price_rub,omitempty"`
	LessonConnectionLink string                 `protobuf:"bytes,5,opt,name=lesson_connection_link,json=lessonConnectionLink,proto3" json:"lesson_connection_link,omitempty"`
...
const file_user_service_proto_rawDesc = "" +
	"\n" +
	"\x12user_service.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb1\x01\n" +
	...
	"\btimezone\x18\x05 \x01(\tR\btimezone\"Q\n" +
	...
	"\n" +
	"student_id\x18\x02 \x01(\tR\tstudentId\"\xb5\x01\n" +
	...
	"\x16lesson_connection_link\x18\x04 \x01(\tR\x14lessonConnectionLink\"\xcd\x01\n" +
	"\x19UpdateTutorStudentRequest\x12\x19\n" +
	"\btutor_id\x18\x01 \x01(\tR\atutorId\x12\x1d\n" +
	"\n" +
	"student_id\x18\x02 \x01(\tR\tstudentId\x12(\n" +
	"\x10lesson_price_rub\x18\x03 \x01(\x05R\x0elessonPriceRub\x124\n" +
	"\x16lesson_connection_link\x18\x04 \x01(\tR\x14lessonConnectionLink\x12\x16\n" +
	...
	"\tedited_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\beditedAt\"l\n" +
	"\n" +
	"UserPublic\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\n" +
	"first_name\x18\x03 \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\x04 \x01(\tR\blastName\"\xae\x02\n" +
	"\fTutorProfile\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12!\n" +
	"\fpayment_info\x18\x03 \x01(\tR\vpaymentInfo\x12(\n" +
	"\x10lesson_price_rub\x18\x04 \x01(\x05R\x0elessonPriceRub\x124\n" +
	"\x16lesson_connection_link\x18\x05 \x01(\tR\x14lessonConnectionLink\x129\n" +
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x127\n" +
	"\tedited_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\beditedAt\"\xc4\x02\n" +
	...
	"\x10lesson_price_rub\x18\x04 \x01(\x05R\x0elessonPriceRub\x124\n" +
	"\x16lesson_connection_link\x18\x05 \x01(\tR\x14lessonConnectionLink\x12\x16\n" +
	"\x06status\x18\x06 \x01(\tR\x06status\x129\n" +
	"\n" +
	"created_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x127\n" +
	"\tedited_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\beditedAt2\xc8\b\n" +
	"\vUserService\x12I\n" +
	...
	"\x1aResolveTutorStudentContext\x12*.user.v1.ResolveTutorStudentContextRequest\x1a$.user.v1.ResolvedTutorStudentContextB\tZ\apkg/apib\x06proto3"
...
var file_user_service_proto_goTypes = []any{
	...
	(*GetTutorStudentRequest)(nil),            // 5: user.v1.GetTutorStudentRequest
	(*CreateTutorStudentRequest)(nil),         // 6: user.v1.CreateTutorStudentRequest
	(*UpdateTutorStudentRequest)(nil),         // 7: user.v1.UpdateTutorStudentRequest
	(*DeleteTutorStudentRequest)(nil),         // 8: user.v1.DeleteTutorStudentRequest
	(*ListTutorStudentsRequest)(nil),          // 9: user.v1.ListTutorStudentsRequest
	(*ListTutorStudentsResponse)(nil),         // 10: user.v1.ListTutorStudentsResponse
	(*ListTutorsForStudentRequest)(nil),       // 11: user.v1.ListTutorsForStudentRequest
	(*ListTutorsForStudentResponse)(nil),      // 12: user.v1.ListTutorsForStudentResponse
	(*ResolveTutorStudentContextRequest)(nil), // 13: user.v1.ResolveTutorStudentContextRequest
	(*ResolvedTutorStudentContext)(nil),       // 14: user.v1.ResolvedTutorStudentContext
	(*Empty)(nil),                             // 15: user.v1.Empty
	(*User)(nil),                              // 16: user.v1.User
	(*UserPublic)(nil),                        // 17: user.v1.UserPublic
	(*TutorProfile)(nil),                      // 18: user.v1.TutorProfile
	(*TutorStudent)(nil),                      // 19: user.v1.TutorStudent
	(*timestamppb.Timestamp)(nil),             // 20: google.protobuf.Timestamp
}
var file_user_service_proto_depIdxs = []int32{
	19, // 0: user.v1.ListTutorStudentsResponse.students:type_name -> user.v1.TutorStudent
	19, // 1: user.v1.ListTutorsForStudentResponse.tutors:type_name -> user.v1.TutorStudent
	20, // 2: user.v1.User.created_at:type_name -> google.protobuf.Timestamp
	20, // 3: user.v1.User.edited_at:type_name -> google.protobuf.Timestamp
	20, // 4: user.v1.TutorProfile.created_at:type_name -> google.protobuf.Timestamp
	20, // 5: user.v1.TutorProfile.edited_at:type_name -> google.protobuf.Timestamp
	20, // 6: user.v1.TutorStudent.created_at:type_name -> google.protobuf.Timestamp
	20, // 7: user.v1.TutorStudent.edited_at:type_name -> google.protobuf.Timestamp
	...
	15, // 10: user.v1.UserService.GetMe:input_type -> user.v1.Empty
	...
	18, // 13: user.v1.UserService.UpdateTutorProfile:input_type -> user.v1.TutorProfile
	4,  // 14: user.v1.UserService.GetTutorProfileByUserId:input_type -> user.v1.GetTutorProfileByUserIdRequest
	5,  // 15: user.v1.UserService.GetTutorStudent:input_type -> user.v1.GetTutorStudentRequest
	6,  // 16: user.v1.UserService.CreateTutorStudent:input_type -> user.v1.CreateTutorStudentRequest
	7,  // 17: user.v1.UserService.UpdateTutorStudent:input_type -> user.v1.UpdateTutorStudentRequest
	8,  // 18: user.v1.UserService.DeleteTutorStudent:input_type -> user.v1.DeleteTutorStudentRequest
	9,  // 19: user.v1.UserService.ListTutorStudents:input_type -> user.v1.ListTutorStudentsRequest
	11, // 20: user.v1.UserService.ListTutorsForStudent:input_type -> user.v1.ListTutorsForStudentRequest
	13, // 21: user.v1.UserService.ResolveTutorStudentContext:input_type -> user.v1.ResolveTutorStudentContextRequest
	16, // 22: user.v1.UserService.RegisterViaTelegram:output_type -> user.v1.User
	16, // 23: user.v1.UserService.AuthorizeByAuthHeader:output_type -> user.v1.User
	16, // 24: user.v1.UserService.GetMe:output_type -> user.v1.User
	17, // 25: user.v1.UserService.GetUser:output_type -> user.v1.UserPublic
	16, // 26: user.v1.UserService.UpdateUser:output_type -> user.v1.User
	18, // 27: user.v1.UserService.UpdateTutorProfile:output_type -> user.v1.TutorProfile
	18, // 28: user.v1.UserService.GetTutorProfileByUserId:output_type -> user.v1.TutorProfile
	19, // 29: user.v1.UserService.GetTutorStudent:output_type -> user.v1.TutorStudent
	19, // 30: user.v1.UserService.CreateTutorStudent:output_type -> user.v1.TutorStudent
	19, // 31: user.v1.UserService.UpdateTutorStudent:output_type -> user.v1.TutorStudent
	15, // 32: user.v1.UserService.DeleteTutorStudent:output_type -> user.v1.Empty
	10, // 33: user.v1.UserService.ListTutorStudents:output_type -> user.v1.ListTutorStudentsResponse
	12, // 34: user.v1.UserService.ListTutorsForStudent:output_type -> user.v1.ListTutorsForStudentResponse
	14, // 35: user.v1.UserService.ResolveTutorStudentContext:output_type -> user.v1.ResolvedTutorStudentContext
